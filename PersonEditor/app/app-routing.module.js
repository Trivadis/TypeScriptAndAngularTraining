...
var routes = [
    ...
    { path: 'person/:personid', component: person_detail_component_1.PersonDetailComponent },
    { path: 'developers', component: persons_on_github_component_1.PersonsOnGithubComponent }
];

...
var programming_languages_component_1 = require('./programming-languages.component');
    ...
    AppModule = __decorate([
        core_1.NgModule({
            imports: [platform_browser_1.BrowserModule, forms_1.FormsModule, router_1.RouterModule.forRoot([
                    { path: 'languages', component: programming_languages_component_1.ProgrammingLanguagesComponent },
            ...
            declarations: [app_component_1.AppComponent,
                ...
                programming_languages_component_1.ProgrammingLanguagesComponent],
